...
const ProfileScreen = ({ navigation }) => {
    ...
    const fetchProfileData = async () => {
        ...
        try {
            const profileResponse = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/users/profile', {
                method: 'GET',
                headers: {
            ...
            const rolesResponse = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/users/profile', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${authToken}`,
                    'Content-Type': 'application/json'
            ...
            const servicesResponse = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/services/user', {
                method: 'GET',
                headers: {
                  'Authorization': `Bearer ${authToken}`,
                  'Content-Type': 'application/json'
    ...
    const fetchUserServices = async () => {
        ...
        setLoading(true);
        try {
            const response = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/services/user', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${authToken}`,
                    'Content-Type': 'application/json'
    ...
    const handleProfileUpdate = async () => {
        ...
        try {
            ...
            const response = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/users/profile', {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${authToken}`,
        ...
        try {
            ...
            switch(roleType) {
                ...
                case 'SERVICE_PROVIDER':
                    result = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/request-service-provider', {
                        method: 'POST',
                    ...
                    break;
                case 'CATERING':
                    result = await fetch('https://8b7f-41-100-123-0.ngrok-free.app/api/request-catering-business', {
                        method: 'POST',
                        body: JSON.stringify({ userId: user.id }),
                        headers: { 'Content-Type': 'application/json' },
                    });
