// Main categories data for the application
export const MAIN_CATEGORIES = [
  {
    id: 'products', // Unique identifier for the category
    name: 'Products', // Display name for the category
    icon: 'basket-outline', // Icon name for the category
    color: '#8BC34A', // Theme color for the category
    subcategories: [ // Array of subcategories under 'Products'
      {
        name: 'Beverages', // Subcategory name
        icon: 'beer-outline', // Icon for the subcategory
        subsubcategories: { // Nested subcategories
